...
# Call the actual G_CLI with LV 19 as parameter and the Caraya G-CLI
g-cli --lv-ver 2023 "C:\Program Files (x86)\National Instruments\LabVIEW 2023\vi.lib\addons\_JKI Toolkits\Caraya\CarayaCLIExecutionEngine.vi" -- -s $f -x $g -v 1 -q 1
